/*  
 *  Efficiency.
 *  Listener from calculates absolute annual increase.
...
//  Create Listener from calculates absolute annual increase

public class AbsoluteIncrease {
	...
	public AbsoluteIncrease() {
		...
		helper_frame.setTitle("Absolute annual increase (years)");
		...
		helper_button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					for (int i = 0; i<=years_count-1; i++) {
						...
						main_button_calc.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								...
								//  Calling method of calculating the absolute annual increase
								
								CalculationOfIndicators c = new CalculationOfIndicators();
								c.CalcAbsoluteIncrease(); 
							}
						});
					...
					main_frame.setTitle("Absolute annual increase");
